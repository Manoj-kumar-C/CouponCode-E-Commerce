<div class="xoo-wsc-premium">
	...
	<ul class="xoo-wscp-features">
		...
		<li>Register with a single click, email and Password less registration</li>
		<li>Manage Registration Fields</li>
		<li>Country Code Flag</li>
		<li>Login With Email OTP</li>
		<li>Login & Register Popup design. This is a separate plugin, feel free to download free version <a href="https://wordpress.org/plugins/easy-login-woocommerce/" target="_blank">here</a><br></li>
	</ul>
</div>